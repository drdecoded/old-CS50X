...
float count_letters(string text)
{
    ...
    {
        count += 1;
        if (text[letters] == 32 || text[letters] == 58 || text[letters] == 59 || text[letters] == 63 || text[letters] == 44 || text[letters] == 34 || text[letters] == 46 || text[letters] == 39 || text[letters] == 45 || text[letters] == 33)
        {
            count -= 1;
        }
    }
